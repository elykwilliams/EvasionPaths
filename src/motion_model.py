...
# one another.
# https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0126383#sec012
class Dorsogna(MotionModel):
    ...
    ## This function reflects points off of the domain elastically, and updates the velocities accordingly
    ...
    # x,y coordinates and velocitites as initial values. If the new x,y coordinates are outside the boundary, the points
    # are reflected inside the domain using an elastic collision model
