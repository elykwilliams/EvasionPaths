...
RUN_NAME="${RUN_NAME:-structured_velocity_weighted_fence025_offset06_30k}"
...
NUM_MOBILE_SENSORS="${NUM_MOBILE_SENSORS:-10}"
MAX_SPEED_SCALE="${MAX_SPEED_SCALE:-0.2}"
FENCE_SENSING_RADIUS="${FENCE_SENSING_RADIUS:-0.25}"
FENCE_OFFSET_RATIO="${FENCE_OFFSET_RATIO:-0.6}"
USE_WEIGHTED_ALPHA="${USE_WEIGHTED_ALPHA:-1}"
SEED="${SEED:-1000}"
...
CONTROL_EFFORT_PENALTY="${CONTROL_EFFORT_PENALTY:-0.01}"
...
cmd=(
  ...
  --num-mobile-sensors "${NUM_MOBILE_SENSORS}"
  --max-speed-scale "${MAX_SPEED_SCALE}"
  --fence-sensing-radius "${FENCE_SENSING_RADIUS}"
  ...
  --control-effort-penalty "${CONTROL_EFFORT_PENALTY}"
  --eval-freq "${EVAL_FREQ}"
