...
RUN_NAME="${RUN_NAME:-homological_gat_eval_10k}"
...
DISABLE_PHASE_REWARD_SCHEDULE="${DISABLE_PHASE_REWARD_SCHEDULE:-1}"
ENABLE_FINAL_HOLE_COMPRESSION_SCHEDULE="${ENABLE_FINAL_HOLE_COMPRESSION_SCHEDULE:-0}"
NEIGHBOR_MIN_RATIO="${NEIGHBOR_MIN_RATIO:-0.8660254037844386}"
NEIGHBOR_MAX_RATIO="${NEIGHBOR_MAX_RATIO:-2.0}"
...
MERGE_HAZARD_WEIGHT="${MERGE_HAZARD_WEIGHT:-0.0}"
...
SUCCESS_TIME_BONUS_WEIGHT="${SUCCESS_TIME_BONUS_WEIGHT:-5.0}"
ONE_HOLE_LINGER_WEIGHT="${ONE_HOLE_LINGER_WEIGHT:-0.0}"
ONE_HOLE_AREA_SCALE_ALPHA="${ONE_HOLE_AREA_SCALE_ALPHA:-1.5}"
ONE_HOLE_PERIMETER_SCALE_ALPHA="${ONE_HOLE_PERIMETER_SCALE_ALPHA:-1.0}"
TIME_PENALTY="${TIME_PENALTY:-0.03}"
AREA_PROGRESS_WEIGHT="${AREA_PROGRESS_WEIGHT:-0.0}"
...
AREA_REGRESS_WEIGHT="${AREA_REGRESS_WEIGHT:-0.0}"
...
AREA_RESIDUAL_WEIGHT="${AREA_RESIDUAL_WEIGHT:-0.0}"
